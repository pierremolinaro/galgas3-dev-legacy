...
GALGAS_string cPtr_lexiqueComponentAST::getter_keyRepresentation (Compiler * inCompiler
  ...
  result_result = GALGAS_string ("lexique ").add_operation (temp_0.readProperty_mLexiqueComponentName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("lexique-component.galgas", 449)) ;
//---
...
void cPtr_lexiqueComponentAST::method_enterDeclarationInGraph (GALGAS_semanticTypePrecedenceGraph & ioArgument_ioSemanticTypePrecedenceGraph,
  ...
  GALGAS_lstring var_key_17140 = GALGAS_lstring::class_func_new (GALGAS_string ("lexique ").add_operation (temp_0.readProperty_mLexiqueComponentName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("lexique-component.galgas", 460)), temp_1.readProperty_mLexiqueComponentName ().readProperty_location (), inCompiler  COMMA_SOURCE_FILE ("lexique-component.galgas", 460)) ;
  {
  const GALGAS_lexiqueComponentAST temp_2 = this ;
  ioArgument_ioSemanticTypePrecedenceGraph.setter_addNode (var_key_17140, temp_2, inCompiler COMMA_SOURCE_FILE ("lexique-component.galgas", 461)) ;
  }
}
//--------------------------------------------------------------------------------------------------
//
...
void cPtr_lexiqueComponentAST::method_enterDeclarationInSemanticContext (const GALGAS_extensionMethodMapForBuildingContext /* constinArgument_inExtensionMethodMapForBuildingContext */,
                                                                         ...
                                                                         Compiler * inCompiler
                                                                         COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lexicalTypeMap var_lexicalTypeMap_17940 = function_buildLexicalTypeMap (inCompiler COMMA_SOURCE_FILE ("lexique-component.galgas", 473)) ;
  GALGAS_lexicalAttributeMap var_lexicalAttributeMap_18007 = GALGAS_lexicalAttributeMap::class_func_emptyMap (SOURCE_FILE ("lexique-component.galgas", 474)) ;
  {
  const GALGAS_lexiqueComponentAST temp_0 = this ;
  routine_buildLexicalAttributeMap_3F__3F__26_ (var_lexicalTypeMap_17940, temp_0.readProperty_mLexicalAttributeListAST (), var_lexicalAttributeMap_18007, inCompiler  COMMA_SOURCE_FILE ("lexique-component.galgas", 475)) ;
  }
  GALGAS_terminalMap var_terminalMap_18203 = GALGAS_terminalMap::class_func_emptyMap (SOURCE_FILE ("lexique-component.galgas", 481)) ;
  const GALGAS_lexiqueComponentAST temp_1 = this ;
  cEnumerator_terminalDeclarationListAST enumerator_18251 (temp_1.readProperty_mTerminalDeclarationListAST (), kENUMERATION_UP) ;
  while (enumerator_18251.hasCurrentObject ()) {
    GALGAS_lexicalSentValueList var_argumentTypeList_18301 = GALGAS_lexicalSentValueList::class_func_emptyList (SOURCE_FILE ("lexique-component.galgas", 483)) ;
    cEnumerator_sentLexicalAttributeListAST enumerator_18370 (enumerator_18251.current_mSentAttributeList (HERE), kENUMERATION_UP) ;
    while (enumerator_18370.hasCurrentObject ()) {
      GALGAS_lexicalTypeEnum var_attributeLexicalType_18468 ;
      var_lexicalAttributeMap_18007.method_searchKey (enumerator_18370.current_mAttributeName (HERE), var_attributeLexicalType_18468, inCompiler COMMA_SOURCE_FILE ("lexique-component.galgas", 485)) ;
      var_argumentTypeList_18301.addAssign_operation (enumerator_18370.current_mFormalSelector (HERE), enumerator_18370.current_mAttributeName (HERE).readProperty_string (), var_attributeLexicalType_18468  COMMA_SOURCE_FILE ("lexique-component.galgas", 486)) ;
      enumerator_18370.gotoNextObject () ;
    }
    {
    var_terminalMap_18203.setter_insertKey (enumerator_18251.current_mName (HERE), var_argumentTypeList_18301, inCompiler COMMA_SOURCE_FILE ("lexique-component.galgas", 488)) ;
    }
    enumerator_18251.gotoNextObject () ;
  }
  const GALGAS_lexiqueComponentAST temp_2 = this ;
  cEnumerator_lexicalListDeclarationListAST enumerator_18683 (temp_2.readProperty_mLexicalListDeclarationListAST (), kENUMERATION_UP) ;
  while (enumerator_18683.hasCurrentObject ()) {
    GALGAS_lexicalSentValueList var_argumentTypeList_18745 = GALGAS_lexicalSentValueList::class_func_emptyList (SOURCE_FILE ("lexique-component.galgas", 492)) ;
    cEnumerator_sentLexicalAttributeListAST enumerator_18814 (enumerator_18683.current_mSentAttributeList (HERE), kENUMERATION_UP) ;
    while (enumerator_18814.hasCurrentObject ()) {
      GALGAS_lexicalTypeEnum var_attributeLexicalType_18913 ;
      var_lexicalAttributeMap_18007.method_searchKey (enumerator_18814.current_mAttributeName (HERE), var_attributeLexicalType_18913, inCompiler COMMA_SOURCE_FILE ("lexique-component.galgas", 494)) ;
      var_argumentTypeList_18745.addAssign_operation (enumerator_18814.current_mFormalSelector (HERE), enumerator_18814.current_mAttributeName (HERE).readProperty_string (), var_attributeLexicalType_18913  COMMA_SOURCE_FILE ("lexique-component.galgas", 495)) ;
      enumerator_18814.gotoNextObject () ;
    }
    cEnumerator_lexicalListEntryListAST enumerator_19061 (enumerator_18683.current_mEntryList (HERE), kENUMERATION_UP) ;
    while (enumerator_19061.hasCurrentObject ()) {
      {
      var_terminalMap_18203.setter_insertKey (enumerator_19061.current_mTerminalSpelling (HERE), var_argumentTypeList_18745, inCompiler COMMA_SOURCE_FILE ("lexique-component.galgas", 498)) ;
      }
  ...
  ioArgument_ioSemanticContext.mProperty_mLexiqueComponentMapForSemanticAnalysis.setter_insertKey (temp_3.readProperty_mLexiqueComponentName (), temp_4.readProperty_mIsTemplate (), var_terminalMap_18203, temp_5.readProperty_mIndexingListAST (), temp_6.readProperty_mTerminalDeclarationListAST (), temp_7.readProperty_mLexicalAttributeListAST (), temp_8.readProperty_mLexicalStyleListAST (), temp_9.readProperty_mLexicalListDeclarationListAST (), inCompiler COMMA_SOURCE_FILE ("lexique-component.galgas", 502)) ;
  }
}
